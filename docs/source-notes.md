...
| yongintt    | <https://cafe.daum.net/yongintt>                                      |      http | production opt-in     | yongintt-2    | 카카오 공식 카페 검색 API로 `{이름} 대회` 최신 50건 조회. 해당 카페 URL·정확한 이름 근거만 저장하고 입상자 사진 게시판은 구조화 기록에서 제외                              |
