...
| airping | <https://airping.co.kr/11player/01.php> | http | parser ready / disabled | airping-2 | 공개 검색 parser와 합성 fixture 완료. 약관상 사전 승낙 없는 정보 복제·제3자 제공 제한으로 운영 자동 연동하지 않음 |
