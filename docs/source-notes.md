...
| newttplay   | <https://www.newttplay.co.kr/bbs/board.php?bo_table=member_search>    |      http | 구현 완료 / 비활성    | newttplay-1   | 비회원 UTF-8 GET, 최대 2페이지. 결과 표만 처리하며 운영 허가 확인 전 환경 변수와 DB를 모두 비활성화                                                                       |
