...
comment on view public.public_player_search is
  'Public player search summaries excluding future tournaments from current observations and preferring standard integrated divisions on same-day records.';
