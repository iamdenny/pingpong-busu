-- Follow-up for projects where migrations 009 and 010 were already applied.
-- Reapply the hardened identity function, nickname privacy constraints, and
-- orphaned Yongin candidate cleanup without deleting source audit history.
