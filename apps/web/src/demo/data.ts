...
export const demoPlayers: PlayerDetail[] = [
  ...
  },
  {
    ...
    records: [{ id: 'r5', date: '2026-01-17', tournament: '경기 가상 오픈', scale: 'province', event: '여자 단식', club: '드라이브탁구회', division: '4부', divisionSystem: 'open', rank: '우승', sourceCode: 'mock', sourceName: '가상 출처', sourceUrl: 'https://example.invalid/mock/result/3', lastCheckedAt: '2026-08-08T02:00:00.000Z' }],
    sources: [{ sourceCode: 'mock', sourceName: '가상 출처', latestRecordDate: '2026-01-17', latestClub: '드라이브탁구회', recentObservedDivision: '4부', recentObservedDivisionSystem: 'open', resultCount: 1, latestRank: '우승', lastCheckedAt: '2026-08-08T02:00:00.000Z', status: 'fresh' }],
  },
];
